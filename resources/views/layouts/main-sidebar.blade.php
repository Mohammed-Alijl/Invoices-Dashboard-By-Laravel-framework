<!-- main-sidebar -->
		...
		<aside class="app-sidebar sidebar-scroll">
			<div class="main-sidebar-header active">
                <a class="desktop-logo logo-light active" href="{{ url('/' . $page='index') }}"><p class="main-logo" alt="logo">Mohammed Alajel</p></a>
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ route('reports.invoices') }}">تقرير الفواتير</a></li>
                            @endcan
                                @can('customer-reports')
							<li><a class="slide-item" href="{{ route('reports.customers') }}">تقرير العملاء</a></li>
                                @endcan
						</ul>
					</li>
                    @endcan
					...
					<li class="slide">
						...
						<ul class="slide-menu">
                            @can('sections')
							<li><a class="slide-item" href="{{ url('/' . $page='sections') }}">قائمة الأقسام</a></li>
                            @endcan
                            @can('products')
