					...
					<div class="main-header-right">
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							<div class="dropdown nav-item main-header-notification">
								<a class="new nav-link" id="bell" href="#">
								...
								<div class="dropdown-menu">
                                    ...
                                    @else
                                        @foreach(auth()->user()->unreadNotifications as $notification)
                                            ...
                                            <a class="d-flex p-3 border-bottom" href="{{route('notification.display',$notification->id)}}">
                                            <div class="drop-img cover-image" data-image-src="{{URL::asset('assets/img/users/' . $notification->data['image'])}}">
                                            </div>
											<div class="mr-3">
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								<a class="profile-user d-flex" href=""><img alt="" src="{{URL::asset('assets/img/users/' . \Illuminate\Support\Facades\Auth::user()->image)}}"></a>
								<div class="dropdown-menu">
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
											<div class="main-img-user"><img alt="" src="{{URL::asset('assets/img/users/' . \Illuminate\Support\Facades\Auth::user()->image)}}" class=""></div>
