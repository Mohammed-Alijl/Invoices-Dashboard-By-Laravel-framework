...
@section('title')
    {{__('Front-end/invoices.invoices.list')}}
@endsection
@section('css')
...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{__('Front-end/invoices.invoices')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">{{__('Front-end/invoices.invoices.list')}}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">{{__('Front-end/invoices.invoices.list')}}</h4>
                        <i class="mdi mdi-dots-horizontal text-gray"></i>
                    </div>
                    @can('add-invoice')
                    <p class="tx-12 tx-gray-500 mb-2">
                    <div class="col-sm-6 col-md-4 col-xl-3 mg-t-20 mg-sm-t-0">
                        <a class="modal-effect btn btn-outline-primary btn-block" href="invoices/create">{{__('Front-end/invoices.invoice.add')}}</a>
                    </div>
                    </p>
                    @endcan
                </div>
