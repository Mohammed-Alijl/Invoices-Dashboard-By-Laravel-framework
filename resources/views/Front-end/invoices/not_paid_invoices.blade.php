...
@section('title')
    {{__('Front-end/invoices.unpaid.invoices.list')}}
@endsection
@section('css')
...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{__('Front-end/invoices.invoices')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{__('Front-end/invoices.unpaid.invoices.list')}}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">{{__('Front-end/invoices.unpaid.invoices.list')}}</h4>
                                            ...
                                            <div class="dropdown-menu tx-13">
                                                ...
                                                <a class="dropdown-item" href="#" data-id="{{ $invoice->id }}"
                                                   ...
                                                   data-target="#modaldemo5"><i
                                                    ...
                                                    <a class="dropdown-item"
                                                       href="{{route('payments.edit',$invoice->id)}}">
