...
@endsection
@section('title')
    {{__('Front-end/invoices.invoice.add')}}
@stop
        ...
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{__('Front-end/invoices.invoices')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                    {{__('Front-end/invoices.invoice.add')}}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('invoices.store') }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="inputName" name="invoice_number"
                                       title="{{__('Front-end/invoices.invoice.number')}}" required>
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select name="section_id" class="form-control" onclick="console.log($(this).val())"
                                    ...
                                    <!--placeholder-->
                                    <option value="" selected disabled>{{__('Front-end/invoices.section.select')}}</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control form-control-lg" id="Discount" name="discount"
                                       title="{{__('Front-end/invoices.discount')}}"
                                       oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                                       value=0 required>
                            </div>
                            ...
                            <div class="col">
                                ...
                                <select name="rate_vat" id="Rate_VAT" class="form-control" onchange="myFunction()">
                                    <!--placeholder-->
                                    <option value="" selected disabled>{{__('Front-end/invoices.select.vat.rate')}}</option>
                        ...
                        <div class="row">
                            <div class="col">
                                <label for="inputName" class="control-label">{{__('Front-end/invoices.value.vat')}}</label>
